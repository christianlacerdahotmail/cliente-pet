...
public class PetController implements PetAPI {
	...
	@Override
	public PetResponse postCliente(UUID idCliente, @Valid PetRequest petRequest) {
	...
	public List<PetClienteListResponse> getPetsDoClienteComId(UUID idCliente) {
		...
		log.info("[finalia] PetController - getPetsDoClienteComId");
	...
	public void deletePetDoClienteComId(UUID idCliente, UUID idPet) {
		...
		log.info("[idCliente] {} - [idPet] {}", idCliente, idPet);
		petService.deletaPetDoClienteComId(idCliente, idCliente);
